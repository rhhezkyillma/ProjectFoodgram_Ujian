...
class HomeFragment : Fragment() {
    ...
    internal lateinit var appBarHeader: AppBarLayout
...
//
//        var FABPost = view.findViewById<FloatingActionButton>(R.id.addPost)
//        FABPost.setOnClickListener {
//            val intentAddPost = Intent(context,PostActivity::class.java)
